...
This repository contains the **V1 Dubbing Automation Pipeline** for Adobe Premiere Pro + ExtendScript + Python tooling.  
It automates the full workflow from **cut initialization**, **voice generation with timestamps**, **final sequence building**, **interview dubbing**, **disclaimer injection**, **titles/lower-thirds translation & batch rendering**, **SFX/BGM retiming**, and **transitions automation**, ending with **automatic Premiere re-import and AME export**.
