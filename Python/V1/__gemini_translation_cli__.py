...
_QUOTA_ENV = Path(__file__).resolve().parent / "quota.env"
_envd = _load_env_file(_QUOTA_ENV)
if _envd.get("GEMINI_BIN") and not os.environ.get("GEMINI_BIN"):
    os.environ["GEMINI_BIN"] = _envd["GEMINI_BIN"]
...
GEMINI_CREDS_SHARED = _to_wsl_path(os.environ.get(
    "GEMINI_CREDS_SHARED",
    "/mnt/z/Automated Dubbings/_tools/gemini/Room-2-Sufiyan/.gemini"
))
GEMINI_CREDS_LOCAL = _to_wsl_path(os.environ.get(
    "GEMINI_CREDS_LOCAL",
    r"C:\__tools\gemini\.gemini"
))
