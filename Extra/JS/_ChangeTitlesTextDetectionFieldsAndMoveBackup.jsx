...
(function () {
  ...
  var SINGLE_PARAM_NAMES = ["History", "Title", "Text", "Main Text", "Heading"];
  ...
  var BODY_PARAM_NAMES = [
    "Body", "Text", "Main Text", "Heading", "History", "Title", "Description",
    "BODY", "TEXT", "MAIN TEXT", "HEADING", "HISTORY", "TITLE", "DESCRIPTION"
  ];
  ...
  function getFontOverrideBaseOrNull() {
    ...
    if (n === "korean" || n === "ko" || n.indexOf("korean") >= 0) return { language: lang, base: KR_BASE };
    if (n === "russian" || n === "ru" || n.indexOf("russian") >= 0) return { language: lang, base: RU_BASE };
    return null;
  }
  ...
  function main() {
    ...
    if (fontOv) log("🔤 Font override ON | language='" + fontOv.language + "' | base='" + fontOv.base + "'", "info");
