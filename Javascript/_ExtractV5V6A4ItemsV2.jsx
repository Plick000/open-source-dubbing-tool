...
(function () {
    ...
    try {
        ...
        if (activeOrig && activeOrig.videoTracks) {
            if (activeOrig.videoTracks[V7_IDX]) clearTrack(activeOrig.videoTracks[V7_IDX]);
            if (activeOrig.videoTracks[V8_IDX]) clearTrack(activeOrig.videoTracks[V8_IDX]);
            if (activeOrig.audioTracks[A4_IDX]) clearTrack(activeOrig.audioTracks[A4_IDX]);
        }
        */

        ok("Done. Created cleaned clone: " + NEW_NAME + " (kept only V5, V6, A4).");
